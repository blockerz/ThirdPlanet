...
public class ThirdPlanetLoose implements Screen {
	...
	public ThirdPlanetLoose(){
		...
		titleLabel = new Label("You have died.", labelStyle);
		//label.setX(0);
		...
		line1 = new Label("Without your help, your people are lost. ", labelStyle);
		titleLabel.setWidth(screenWidth/3);
		titleLabel.setAlignment(Align.center);
		
		line2 = new Label("They will likely be destroyed by the hostile aliens.", labelStyle);
		titleLabel.setWidth(screenWidth/3);
		titleLabel.setAlignment(Align.center);
